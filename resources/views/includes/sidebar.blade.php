	...
	<div class="sidebar-inner slimscroll">
		<div id="sidebar-menu" class="sidebar-menu">
			...
			<ul>
                ...
                @role('doctor')
				<li class="submenu">
					<a href="#"><i class="fas fa-user-md"></i><span> Doctor</span> <span class="menu-arrow"></span></a>
					<ul style="display: none;">
						<li><a class="{{ route_is(('doctor')) ? 'active' : '' }}" href="{{route('doctor')}}">Prescription</a></li>
						<li><a class="{{ route_is('add-medicine') ? 'active' : '' }}" href="{{route('add-medicine')}}">Add medicine</a></li>
                ...
                @role('receptionist')
				<li class="submenu">
					<a href="#"><i class="fas fa-file-alt"></i><span>Register</span> <span class="menu-arrow"></span></a>
					<ul style="display: none;">
						<li><a class="{{ route_is('patient-register') ? 'active' : '' }}" href="{{route('patient-register')}}">Registered Patients</a></li>
						<li><a class="{{ route_is('add-register') ? 'active' : '' }}" href="{{route('add-register')}}">Add Registration</a></li>
					</ul>
				</li>
                @endrole
                ...
                @role('super-admin')
				<li>
					<a href="/chatify"><i class="far fa-comment-dots"></i> <span>Chat</span></a>
				</li>
                @endrole
