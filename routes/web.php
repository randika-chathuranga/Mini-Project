...
Route::group(['middleware'=>['auth']],function (){
    ...
    Route::get('doctor/create',[DoctorController::class,'create'])->name('add-medicine');
    ...
    Route::get('add-register',[PatientRegisterController::class,'create'])->name('add-register');
    Route::post('add-register',[PatientRegisterController::class,'store']);
    Route::delete('patient-register',[PatientRegisterController::class,'destroy']);
